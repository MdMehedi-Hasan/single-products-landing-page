    ...
    return (
        <div id='header' className='bg-white flex justify-center relative py-10 h-screen overflow-hidden'>
            <div className='container flex items-center justify-between'>
                <div className='flex flex-col' data-aos="fade-right"  data-aos-easing="ease-in-out" data-aos-delay="200" data-aos-duration="500" data-aos-once="false"  data-aos-mirror="true">
                ...
                <div className='relative' data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-delay="200" data-aos-duration="500" data-aos-once="false"  data-aos-mirror="true">
